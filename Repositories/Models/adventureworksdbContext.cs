...
namespace Repositories.Models
{
    public partial class adventureworksdbContext : DbContext
    {
        ...
        public virtual DbSet<SpGetProductById> SpGetProductById { get; set; }
...
//                optionsBuilder.UseSqlServer("server=reportdb1.database.windows.net;database=adventureworksdb;User Id=dbadmin;password=NewPass123!@#;Trusted_Connection=False;MultipleActiveResultSets=true;");
//            }
//        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<SpGetProductById>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("spGetProductById");
